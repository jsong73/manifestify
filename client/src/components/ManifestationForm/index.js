...
const ManifestationForm = () => {
    ...
    return (
        <div className="flex justify-center h-screen text-center">
          ...
          <form ref={formRef} className="button mt-8 space-y-6" onSubmit={manifestationFormHandler}>
       
          <div>
          <label> Today I am feeling... </label>
          <input
            className="w-5/6 mt-2 bg-transparent border border-white rounded-full px-2 py-2 text-center"
            name="todaysFeeling"
          ...
          <label> I would like to share the following details about my manifestations... </label>
            ...
            <button className="text-md text-shadow border border-white rounded-full px-4 py-4 mt-12" type="submit">
